...
ax.plot(results_df["Model"], results_df["Accuracy"], marker='o', label="Accuracy")
ax.plot(results_df["Model"], results_df["Precision"], marker='s', label="Precision")
ax.plot(results_df["Model"], results_df["Recall"], marker='^', label="Recall")

ax.set_title("Model Comparison on Selected Features")
ax.set_xlabel("Model")
ax.set_ylabel("Score")
ax.set_ylim(0, 1.1)
ax.grid(True)
